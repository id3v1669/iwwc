...
pub struct NotificationSettings {
    ...
    pub dnd: Option<FieldValue<f32>>,
    pub timeout_low: Option<FieldValue<std::time::Duration>>,
    pub timeout_normal: Option<FieldValue<std::time::Duration>>,
    pub timeout_critical: Option<FieldValue<std::time::Duration>>,
    pub urgency_low: Option<FieldValue<Color>>,
    pub urgency_normal: Option<FieldValue<Color>>,
    pub urgency_critical: Option<FieldValue<Color>>,
    pub layer: Option<FieldValue<Layer>>,
