...
pub(crate) fn build_notification(
    ...
    NotificationSettings {
        ...
        dnd: field_f32("dnd", node, source, errs),
        timeout_low: field_parsed(
            "timeout_low",
            node,
            source,
            errs,
            parse_interval,
            "a duration string e.g. \"500ms\", \"5s\"",
        ),
        timeout_normal: field_parsed(
            "timeout_normal",
            node,
            source,
            errs,
        ...
        urgency_low: field_color("urgency_low", node, source, errs),
        urgency_normal: field_color("urgency_normal", node, source, errs),
        urgency_critical: field_color("urgency_critical", node, source, errs),
        layer: field_parsed(
            "layer",
            node,
            source,
