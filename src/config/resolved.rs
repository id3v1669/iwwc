...
pub struct ResolvedNotificationSettings {
    ...
    pub max: u32,
    pub dnd: u8,
    pub timeout_ms: [i32; 3],
    pub urgency_color: [Color; 3],
    pub layer: Layer,
    pub output: OutputOption,
...
impl Default for ResolvedNotificationSettings {
    fn default() -> Self {
        ResolvedNotificationSettings {
            ...
            max: 5,
            dnd: 0,
            timeout_ms: [10000, 5000, 0],
            urgency_color: [
                Color::from_str("bdae93").unwrap(),
                Color::from_str("98971a").unwrap(),
                Color::from_str("cc241d").unwrap(),
            ],
            layer: Layer::Overlay,
